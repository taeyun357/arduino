...
#define _DUTY_NEU 1525// servo neutral position (90 degree)
#define _DUTY_MAX 3050 // servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  // add your code here!
   if (dist_ema < _TARGET_LOW) {
    ...
    myservo.writeMicroseconds(_DUTY_MIN + 170*(dist_raw-180)/10); 
  }
